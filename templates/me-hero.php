...
global $pro_custom_background, $medium_image_url, $full_image_url, $default_position, $default_size, $thumbnail_image_url, $tablet_size, $current_user_id;
...
function me_hero_styles()
{ 
   global $pro_custom_background, $medium_image_url, $full_image_url, $default_position, $default_size, $thumbnail_image_url, $tablet_size;
    ?>
...
add_action('wp_footer', 'me_hero_styles', 990);
