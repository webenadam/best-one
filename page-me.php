...
<?php get_template_part('template-parts/me-hero', null, array('pro_post_id' => $pro_post_id, 'page_title' => 'עריכת פרטים')) ?>

    <section id="about">
        <inner style="padding-left: 25%; padding-top:var(--gap-m); padding-bottom:160px;">
...
<div id="status-list" class="flex-column gap-s"></div>
    ...
    <section id="reviews" class="light" style="padding-top: 50px;">
        <inner class="flex-column align-center" style="text-align: center;">
            <h2 style="color: var(--green); width: 500px; margin-bottom:70px;"><span style="border-bottom: 2px solid var(--blue);"><?= get_field('pro_recommended_count', $pro_post_id); ?> אנשים</span> שיתפו את החוויה שלהם איתך</h2>
            <?php
            $args = array(
