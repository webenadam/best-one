...
<main id="site-content" role="main">
    <section class="section-404" style="background-image: url('<?= get_template_directory_uri(); ?>/img/hero_bg.jpg');">
        <inner class="flex flex-column align-center justify-center" style="padding: var(--gap-m); text-align: center;">
            ...
            <a class="button" href="<?= esc_url(home_url('/')); ?>"><?php _e('חזרה לדף הבית', 'best-one'); ?></a>
        </inner>
    </section>
</main>
